    ...
    <div className="min-h-screen bg-background p-4 sm:p-8">
      <div className="mx-auto max-w-4xl space-y-8">
        <div className="text-center">
            ...
            <p className="text-muted-foreground">Last updated on 20-12-2025 21:40:55</p>
        </div>
        ...
        <Card>
            <CardContent className="p-6 md:p-8 space-y-6 text-muted-foreground">
                <p>
                    These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding agreement by and between calicut information technology, ( “Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).
                </p>
                <p>
                    By using our website and availing the Services, you agree that you have read and accepted these Terms (including the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It is your responsibility to periodically review these Terms to stay informed of updates.
                </p>
                
                <h2 className="text-xl font-semibold text-foreground pt-4">The use of this website or availing of our Services is subject to the following terms of use:</h2>
                <ul className="space-y-4 list-disc pl-6">
                    ...
                    <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in calicut, Kerala</li>
