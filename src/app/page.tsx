        ...
        <div className="min-h-screen bg-[#1a1c23]">
            ...
            <div className="max-w-4xl mx-auto p-4 sm:p-8">
                <header className="text-center py-8 sm:py-12">
                    ...
                    <p className="mt-4 text-[10px] sm:text-sm font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-orange-500/50 max-w-2xl mx-auto">
                        DIRECT PROFESSIONAL CONNECTIONS
                    </p>
                </header>

                <main className="space-y-12">
                    <section className="bg-[#24262d] rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 shadow-2xl overflow-hidden border border-white/5">
                        <div className="mb-8">
                            <h2 className="text-xl sm:text-2xl font-black text-white uppercase italic">Top Rated Experts</h2>
                            <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-muted-foreground">PREMIUM NETWORK SUGGESTIONS</p>
                        </div>
                        ...
                        <div className="relative group mb-8">
                            ...
                            <Input 
                                ...
                                className="pl-12 h-14 bg-[#1a1c23] border-none rounded-2xl text-white text-base sm:text-lg placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-orange-500 transition-all shadow-inner" 
                            ...
                            <div className="flex gap-6 overflow-x-auto pb-8 pt-2 scrollbar-hide snap-x px-1">
                                {isLoadingTopExperts ? (
                                    ...
                                    filteredTopExperts.map(expert => (
                                        <Card key={expert.id} className="min-w-[220px] sm:min-w-[240px] max-w-[240px] bg-[#1a1c23] border-none flex flex-col items-center p-6 sm:p-8 text-center rounded-[2rem] sm:rounded-[2.5rem] snap-start transition-all hover:scale-[1.05] group shadow-xl relative overflow-hidden">
                                            ...
                                            <div className="relative mb-6 z-10">
                                                <Avatar className="h-20 w-20 sm:h-24 sm:w-24 border-4 border-white/10 group-hover:border-orange-500/50 transition-colors duration-500 shadow-2xl">
                                                    <AvatarImage src={expert.photoUrl} className="object-cover" />
                                                    <AvatarFallback className="bg-orange-500/10 text-orange-500 text-2xl sm:text-3xl font-black">
                                                        {expert.firstName?.[0]}
                                                    </AvatarFallback>
                                                </Avatar>
                                                {expert.verified ? (
                                            ...
                                            <p className="font-black text-white text-lg sm:text-xl line-clamp-1 mb-1 tracking-tight uppercase italic z-10">{expert.firstName} {expert.lastName}</p>
                                            <p className="text-[9px] sm:text-[10px] text-[#8a92a6] uppercase tracking-[0.2em] font-black mb-10 line-clamp-1 h-4 z-10">{expert.profession || expert.role}</p>
                                            <Button 
                                                className="w-full bg-orange-500 hover:bg-orange-600 text-white rounded-2xl font-black text-[10px] sm:text-xs h-12 shadow-xl shadow-orange-500/20 active:scale-95 transition-transform z-10 uppercase tracking-widest"
                                    ...
                                    <div className="w-full flex flex-col items-center justify-center py-16 bg-white/5 rounded-[2rem] sm:rounded-[2.5rem] border-2 border-dashed border-white/10">
                                        <Sparkles className="h-16 w-16 text-orange-500/20 mb-4 animate-pulse" />
                                        <p className="text-lg sm:text-xl font-black text-white/40 tracking-tight uppercase italic">Our Premium Network is Growing</p>
                                        <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 max-w-xs text-center mt-2">SHOWCASE YOUR EXPERTISE AT THE TOP</p>
                    ...
                    <Card className="transition-all bg-[#24262d] border-none hover:shadow-2xl hover:shadow-orange-500/5 rounded-[2rem] sm:rounded-[2.5rem] p-4 overflow-hidden border border-white/5">
                        <CardHeader>
                             <div className="flex items-center justify-between">
                                <CardTitle className="flex items-center gap-2 sm:gap-3 text-xl sm:text-2xl font-black text-white uppercase italic">
                                    <Sparkles className="text-orange-500 h-5 w-5 sm:h-6 sm:w-6" /> Smart Engine
                                </CardTitle>
                                <div className="flex items-center space-x-2 sm:space-x-3 bg-white/5 px-3 sm:px-4 py-1.5 sm:py-2 rounded-2xl border border-white/5">
                                    <Switch id="ai-mode" checked={useAiSearch} onCheckedChange={handleAiModeToggle} className="data-[state=checked]:bg-orange-500 scale-75 sm:scale-90" />
                                    <Label htmlFor="ai-mode" className="flex items-center gap-2 font-black text-[8px] sm:text-[10px] uppercase tracking-widest cursor-pointer">
                                        <Bot className={cn("h-3 w-3 sm:h-4 sm:w-4 transition-colors", useAiSearch ? "text-orange-500" : "text-muted-foreground")} />
                                        AI Search
                                    </Label>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-stretch gap-3">
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <Button variant="outline" className="w-full sm:w-auto justify-start text-left font-black uppercase text-[9px] sm:text-[10px] tracking-widest rounded-2xl h-14 bg-[#1a1c23] border-none shadow-inner">
                                    ...
                                    <DialogContent className="rounded-[2rem] sm:rounded-[2.5rem] border-none bg-[#1a1c23] text-white">
                                        <DialogHeader>
                                            <DialogTitle className="text-xl sm:text-2xl font-black uppercase italic tracking-tight">Classification</DialogTitle>
                                        </DialogHeader>
                                                    ...
                                                    >
                                                        <CardHeader className="flex flex-row items-center justify-between p-4 sm:p-5">
                                                            <div className="flex items-center gap-4">
                                                                <div className="p-2 sm:p-3 bg-white/5 rounded-xl group-hover:bg-orange-500/10 transition-colors">
                                                                    <type.icon className="h-5 w-5 sm:h-6 sm:w-6 text-orange-500" />
                                                                </div>
                                                                <CardTitle className="text-xs sm:text-sm font-black uppercase tracking-widest">{type.label}</CardTitle>
                                                            </div>
                                ...
                                <div className="relative flex-grow">
                                    <Input
                                        id="ai-search"
                                        placeholder={useAiSearch ? `e.g. 'available verified plumber'` : `Search by keyword, name, profession...`}
                                        className={cn("text-sm sm:text-base h-14 bg-[#1a1c23] border-none rounded-2xl focus-visible:ring-2 focus-visible:ring-orange-500 shadow-inner")}
                                        value={aiSearchQuery}
                                        onChange={(e) => setAiSearchQuery(e.target.value)}
                                        onKeyDown={(e) => e.key === 'Enter' && handleAiSearch()}
                                    />
                                </div>
                                <Button onClick={handleAiSearch} disabled={isParsingQuery} className="w-full sm:w-auto h-14 rounded-2xl bg-orange-500 hover:bg-orange-600 font-black px-10 shadow-xl shadow-orange-500/20 uppercase tracking-widest text-xs sm:text-sm">
                             ...
                             {mounted && !useAiSearch && userProfile?.tier !== 'Super Premier' && (
                                <p className="text-[8px] sm:text-[10px] text-orange-500 font-black uppercase tracking-[0.15em] sm:tracking-[0.2em] mt-2 flex items-center gap-2 opacity-70">
                    ...
                    <div className="relative text-center">
                        ...
                        <div className="relative inline-block bg-[#1a1c23] px-6 text-[8px] sm:text-[9px] font-black uppercase tracking-[0.3em] sm:tracking-[0.4em] text-muted-foreground/40">
                            MANUAL PARAMETERS
                        </div>
                    </div>

                    <Card className="rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 bg-[#24262d] border-none shadow-2xl relative overflow-hidden border border-white/5">
                        ...
                        <CardContent className="p-0 space-y-8 sm:space-y-10">
                             <div className="space-y-3">
                                <Label htmlFor="search" className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">I&apos;M LOOKING FOR...</Label>
                                <div className="relative group">
                                    <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground group-focus-within:text-orange-500 transition-colors" />
                                    <Input
                                        id="search"
                                        placeholder="Name, profession, skill, or company..."
                                        className="pl-12 h-14 bg-[#1a1c23] border-none rounded-2xl text-white text-sm sm:text-base placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-orange-500 shadow-inner"
                                        value={searchQuery}
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between mb-1">
                                    <Label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">LOCATION FILTERING</Label>
                                    <Button variant="ghost" size="sm" onClick={handleDetectLocation} disabled={isDetectingLocation} className="text-orange-500 font-black uppercase text-[9px] sm:text-[10px] tracking-widest hover:bg-orange-500/5 h-8 rounded-xl px-4 group">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <Input id="city" placeholder="District / City" className="bg-[#1a1c23] border-none h-14 rounded-2xl font-bold px-6 shadow-inner text-sm" value={city} onChange={(e) => setCity(e.target.value)} />
                                    <Input id="state" placeholder="State" className="bg-[#1a1c23] border-none h-14 rounded-2xl font-bold px-6 shadow-inner text-sm" value={state} onChange={(e) => setState(e.target.value)} />
                                    <Input id="pincode" placeholder="Pincode" className="bg-[#1a1c23] border-none h-14 rounded-2xl font-bold px-6 shadow-inner text-sm" value={pincode} onChange={(e) => setPincode(e.target.value)} />
                                </div>
                            </div>
                            
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <Label className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">BUDGET RANGE</Label>
                                    <div className="flex items-center gap-3">
                                        <span className="text-[9px] sm:text-[10px] font-black text-white uppercase tracking-wider">Max Rate</span>
                                        <Badge className={cn("rounded-full px-3 sm:px-4 h-6 sm:h-7 text-[9px] sm:text-[10px] font-black uppercase tracking-widest border-none transition-all", maxRate ? "bg-orange-500 text-white" : "bg-white/5 text-orange-500/50")}>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex items-center space-x-4 bg-[#1a1c23] p-4 sm:p-5 rounded-2xl border border-white/5 group hover:bg-white/[0.03] transition-colors cursor-pointer" onClick={() => setShowVerifiedOnly(!showVerifiedOnly)}>
                                    ...
                                    <Label htmlFor="verified" className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-white/80 cursor-pointer select-none">Verified Members</Label>
                                </div>
                                <div className="flex items-center space-x-4 bg-[#1a1c23] p-4 sm:p-5 rounded-2xl border border-white/5 group hover:bg-white/[0.03] transition-colors cursor-pointer" onClick={() => setShowAvailableOnly(!showAvailableOnly)}>
                                    ...
                                    <Label htmlFor="available" className="text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-white/80 cursor-pointer select-none">Available Now</Label>
                                </div>
                            </div>

                            <Button size="lg" className="w-full h-16 sm:h-20 rounded-[1.5rem] sm:rounded-[2rem] bg-orange-500 hover:bg-orange-600 text-white font-black text-sm sm:text-xl shadow-2xl shadow-orange-500/30 active:scale-[0.98] transition-all uppercase tracking-widest sm:tracking-[0.2em] group" onClick={handleSearch}>
                    ...
                    <div className="mt-16 text-center">
                        <h2 className="text-2xl sm:text-3xl font-black text-white mb-2 uppercase italic">Industry Hub</h2>
                        <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.3em] text-orange-500/50 mb-10">EXPLORE BY SPECIALIZATION</p>
                         {isAppConfigLoading ? (
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                {homepageCategories.map((category) => (
                                    <Link key={category.id} href={`/search?q=${encodeURIComponent(category.name)}`} passHref>
                                        <Card className="flex flex-col items-center justify-center p-6 sm:p-8 h-full bg-[#24262d] border-none hover:bg-orange-500/5 hover:ring-2 hover:ring-orange-500/50 transition-all rounded-[2rem] sm:rounded-[2.5rem] group cursor-pointer shadow-xl">
                                            <div className="p-4 sm:p-5 bg-[#1a1c23] rounded-2xl mb-4 group-hover:bg-orange-500/10 group-hover:scale-110 transition-all duration-500 shadow-inner">
                                                {getIcon(category.icon)}
                                            </div>
                                            <p className="font-black text-[10px] sm:text-xs text-white group-hover:text-orange-500 transition-colors uppercase tracking-widest">{category.name}</p>
                                        </Card>
                                    </Link>
                                ))}
                            </div>
                        ...
                        <div className="mt-20">
                            <div className="flex flex-col sm:flex-row items-center justify-between mb-10 gap-4">
                                <div className="text-center sm:text-left">
                                    <h2 className="text-2xl sm:text-3xl font-black text-white uppercase italic">Fresh Talent</h2>
                                    <p className="text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-orange-500/50">NEWLY JOINED PROFESSIONALS</p>
                                </div>
                                <Button className="w-full sm:w-auto rounded-2xl bg-orange-500 hover:bg-orange-600 text-white font-black uppercase text-[10px] sm:text-[11px] tracking-widest h-14 px-8 transition-all shadow-xl active:scale-95 shadow-orange-500/20" asChild>
                            ...
                            {isLoadingExperts ? (
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    {recentExperts && recentExperts.length > 0 ? (
                                        ...
                                        <div className="text-center py-20 bg-[#24262d] rounded-[2rem] sm:rounded-[3rem] border-2 border-dashed border-white/5 col-span-2 shadow-inner">
                                            <Users className="h-16 w-16 mx-auto text-muted-foreground/10 mb-4" />
                                            <p className="text-muted-foreground font-black uppercase tracking-widest text-[10px] opacity-40">Grid update in progress.</p>
                                        </div>
                                    )}
                                </div>
                            )}
            ...
            <Dialog open={isPremiumDialogOpen} onOpenChange={setIsPremiumDialogOpen}>
                <DialogContent className="rounded-[2rem] sm:rounded-[3rem] border-none bg-[#1a1c23] p-10 text-white shadow-2xl">
                    <DialogHeader className="items-center text-center">
                        <div className="p-6 bg-orange-500/10 rounded-full w-fit mb-6 shadow-inner">
                            <Sparkles className="h-12 w-12 sm:h-14 sm:w-14 text-orange-500" />
                        </div>
                        ...
                        <UiDialogDescription className="text-base sm:text-lg text-muted-foreground font-medium pt-2">
                            AI-Powered Search is reserved for top-tier members.
                        </UiDialogDescription>
                    </DialogHeader>
                    <div className="text-center space-y-4 py-6">
                        <p className="text-white/70 font-medium leading-relaxed text-sm sm:text-base">
                            Unlock the elite smart engine and priority placement to maximize client engagement.
                        </p>
                    </div>
