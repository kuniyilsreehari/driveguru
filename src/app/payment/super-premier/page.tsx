...
function SuperPremierPaymentPageContent() {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl sm:text-3xl">Upgrade to Super Premier</CardTitle>
                    <CardDescription>Get maximum visibility and all features by upgrading to Super Premier.</CardDescription>
                </CardHeader>
