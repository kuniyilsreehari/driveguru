...
import { Loader2, ChevronLeft, ShieldCheck, ExternalLink } from 'lucide-react';
...
function VerificationPaymentPageContent() {
            ...
            <div className="space-y-6">
                ...
                <Card>
                    <CardHeader className="items-center text-center">
                        ...
                        <CardTitle className="text-2xl sm:text-3xl">Already Verified</CardTitle>
                        <CardDescription>Your account is already verified. No further action is needed.</CardDescription>
                    </CardHeader>
                </Card>
            </div>
        );
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="text-2xl sm:text-3xl">Become a Verified Expert</CardTitle>
                    <CardDescription>Complete the payment to get the verified badge on your profile. This helps build trust with clients.</CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center justify-center gap-8 p-8 text-center">
                   <ShieldCheck className="h-24 w-24 text-primary" />
                   <div>
                    <h3 className="text-xl font-bold">One-Time Verification Fee</h3>
                    <p className="text-muted-foreground mt-2">
                        Proceed to our secure payment gateway to complete the verification process.
                    </p>
                   </div>
                </CardContent>
                <CardFooter>
